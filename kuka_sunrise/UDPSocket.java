...
public class UDPSocket implements ISocket{
		...
		while (!isConnected){
			try{
		        ...
		        if(s.length()<1){
		    	   udpConn.close();
		       		isConnected=false;
		       		System.out.println("No message received in 5 seconds, shutting off");
		       		break;
		       	 }
		        ...
		        System.out.println("ERROR connecting to the server for port: " + this.COMport + " Error: " + e1);
		        isConnected=false;
		        close();
				b = new BindException();
    ...
    public void send_message(String msg)
	{
     ...
     try {
			...
			System.out.println("Could not send package: " + e);
		}
	}
    @Override
	public String receive_message()
	{
		...
		try{
			...
			System.out.println("Error receiving package: " + e);
			return " ";
		}
	}
	...
	public void close(){
		try {
			...
			System.out.println("ERROR closing the communication port to ROS: " + COMport);
		}
	}
