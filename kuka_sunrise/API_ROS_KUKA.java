...
//import com.kuka.roboticsAPI.deviceModel.KMR; // IS THIS CORRECT?
...
public class API_ROS2_KUKA extends RoboticsAPIApplication {
	public boolean RUN = false;  // Is socket Connected and app running?
	public boolean isCompliance = false;
	public boolean isCollision = false;
	
	public LBR lbr;  // Kuka iiwa LBR robotarm
	//public KMR kmr; // KUKA iiwa KMR mobile robot - IS THIS CORRECT?
	// public MobilePlatform KMR
	public Tool tool;
	...
	public static void main(String[] args){
		API_ROS2_KUKA app = new API_ROS2    _KUKA();
		app.runApplication();
