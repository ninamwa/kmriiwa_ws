...
from kuka_communication.msg.LbrStatusdata import LbrStatusdata
...
class ManipulatorNode(Node):
    def __init__(self):
        ...
        sub_pathplanning = self.create_subscription(LbrStatusdata,'/lbr_statusdata',self.lbr_statusdata_callback, qos_profile_sensor_data)
