...
def generate_launch_description():
    ...
    rviz_config_dir3 = os.path.join(get_package_share_directory('kmr_cartographer'),'rviz','kmr_cartographer_withd435.rviz'),

    cartographer_config_dir = os.path.join(
        get_package_share_directory('kmr_cartographer'),
        'config')

    configuration_basename = LaunchConfiguration('configuration_basename', default='kmr_2d.lua'),
