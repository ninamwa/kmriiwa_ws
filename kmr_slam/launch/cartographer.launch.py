...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        launch_ros.actions.Node(
           ...
           output='screen',
           parameters=[{'output_frame':'d435_base_front_link'},{'use_sim_time': use_sim_time},{'range_max':10.0},{'scan_height':240}],
        ...
        launch_ros.actions.Node(
           ...
           output='screen',
           parameters=[{'output_frame':'d435_base_left_link'},{'use_sim_time': use_sim_time},{'range_max':10.0},{'scan_height':240}],
